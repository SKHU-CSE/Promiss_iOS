...
extension UIColor {
    ...
    @nonobjc class var pmSeaBlue: UIColor {
        return UIColor(red: 69 / 255, green: 79 / 255, blue: 161 / 255, alpha: 1.0)
    }
    ...
    @nonobjc class var pmSkyBlue: UIColor {
        return UIColor(red: 0 / 255, green: 176 / 255, blue: 240 / 255, alpha: 1.0)
    }
}
